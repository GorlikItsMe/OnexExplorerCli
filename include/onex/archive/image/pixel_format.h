...
namespace onex::archive {
  ...
  /// The seven NOS pixel formats used by the original OnexExplorer.
  ///
  /// Each enumerator describes how raw pixel bytes are packed before conversion
  /// to RGBA8 (or after conversion from RGBA8).
